...
public class MainActivity extends Activity {
    ...
    private void expenseDialog(JSONObject o){
        ...
        String stamp=o.optLong("time",0)>0?new SimpleDateFormat("HH:mm • dd/MM/yyyy",new Locale("vi","VN")).format(new java.util.Date(o.optLong("time"))):o.optString("date",""); details.addView(detailRow("Ngày giao dịch",text(stamp,14,INK,true))); box.addView(details,top(12));
        ...
        noteRow.setOnClickListener(v->editExpenseNote(o,detail,noteValue)); categoryChip.setOnClickListener(v->editExpenseCategory(o,detail)); sourceChip.setOnClickListener(v->editExpenseSource(o,detail)); detail.show();
    }
