...
final class NotificationHelper {
    ...
    static Notification status(Context c) {
        ...
        RemoteInput input = new RemoteInput.Builder(INPUT_KEY).setLabel("Nhập khoản chi").build();
        ...
        java.text.NumberFormat amounts = java.text.NumberFormat.getIntegerInstance(new java.util.Locale("vi", "VN"));
        String line = "Chi hôm nay " + amounts.format(s.todaySpent()) + "đ/" + amounts.format(s.todayAllowance()) + "đ";
        if (over) line += " ⚠";
